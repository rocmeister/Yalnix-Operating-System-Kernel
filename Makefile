...
#
ALL = yalnix init init1 init2 exectest console idle forktest0 forktest1 forktest1b forktest2 forktest2b forktest3 delaytest exectest brktest trapmemory bigstack blowstack ttyread1 shell ttywrite1 ttywrite2 ttywrite3 forkwait0c forkwait0p forkwait1 forkwait1b forkwait1c forkwait1d trapillegal trapmath

#
#	You must modify the KERNEL_OBJS and KERNEL_SRCS definitions
#	below.  KERNEL_OBJS should be a list of the .o files that
#	make up your kernel,make and KERNEL_SRCS should  be a list of
